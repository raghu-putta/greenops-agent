...
- Total running VMs (names, zones, machine types)
- Total unattached disks (names, sizes)
...
- Estimated monthly cost waste in USD (rough estimate: $10/VM/month idle, $0.04/GB/month disk, $7.20/IP/month)
- Risk classification for each action:
  * LOW risk: stop VMs idle 30+ days, release unattached IPs, delete unattached disks
  * MEDIUM risk: resize active VMs
...
If there are no resources to optimize, report that the project is already optimized.
...
# GreenOps AI Report
**Project:** budget-finance-mcp
**Date:** [today's date]
**Generated by:** GreenOps Agentic AI Pipeline
...
[List actions requiring manual review]
...
greenops_pipeline = SequentialAgent(
    name="greenops_orchestrator",
    description="End-to-end GreenOps pipeline: Carbon Scout → Analyzer → Executor → Report",
    sub_agents=[
        carbon_scout,
        greenops_analyzer,
